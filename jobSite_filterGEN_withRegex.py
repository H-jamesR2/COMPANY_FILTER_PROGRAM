...
def create_company_filter_list():
    ...
    filters = {
        "Linkedin": [
            ...
            'linkedin.com##li.ember-view.jobs-search-results__list-item:has(span.cSgAFzYHhlVAudlPUBRKZppIxOTCPQFaRzd:has-text(/({pattern})/i))',
            "",
            ...
            'linkedin.com##li.ember-view.jobs-search-results__list-item:has(div.job-card-container__footer-item--highlighted:has-text(We won’t show you this job again))',
        ...
        "GoogleJobs":[
            ...
            "",
            'google.com##div.EimVGf:has(div.wHYlTd.MKCbgd:has-text(/({pattern})/i))',
            ""
        ]
    }
